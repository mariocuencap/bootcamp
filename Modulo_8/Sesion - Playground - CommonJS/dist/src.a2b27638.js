...
// account-business.js
var EstiloNodo = require("./style-business");
...
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
// client-business.js
var Cuentas = require("./data-business");
var ElementoCuentaCliente = require("./account-business");
...
var Clientes = require("./data-business");
var ElementoCliente = require("./client-business");
...
// index.js
var ImprimirCuentas = require("./client-list-business");
